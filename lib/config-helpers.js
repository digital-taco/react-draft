...
function getHMRPath(name, disableLogging, subPath = '') {
  const hotMiddlewareScript = `node_modules/webpack-hot-middleware/client?path=${subPath}/__webpack_hmr&timeout=20000&reload=true${name &&
    `&name=${name}`}${disableLogging && '&quiet=true'}`
